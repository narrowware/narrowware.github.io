(function ($) {
    ...
    $(".service-slider-area").owlCarousel({ autoplayHoverPause: true, autoplaySpeed: 1500, autoplay: true, loop: true, dots: true, margin: 25, responsive: { 0: { items: 1 }, 768: { items: 2 }, 992: { items: 3 } } });
    $(".testimonial-slider-area").owlCarousel({ autoplayHoverPause: true, autoplaySpeed: 1500, autoplay: true, loop: true, dots: true, margin: 30, responsive: { 0: { items: 1 }, 768: { items: 2 } } });
    $(".testimonial-slider-area-2").owlCarousel({ autoplayHoverPause: true, autoplaySpeed: 1500, autoplay: true, loop: true, dots: true, margin: 25, responsive: { 0: { items: 1 }, 768: { items: 2 }, 992: { items: 3 } } });
    $(".partner-slider-area").owlCarousel({
        ...
        dots: false,
        margin: 30,
        responsive: { 0: { items: 3, margin: 20 }, 576: { items: 3, margin: 50 }, 768: { items: 4, margin: 80 }, 992: { items: 5, margin: 80 }, 1200: { items: 6, margin: 100 } },
    });
